...
def args():
    ...
    arg.add_argument("-f", "--file", type=str, required=True, help="Input file path.")
    arg.add_argument("-o", "--out_file", type=str, default="ASCII.stl", help="Output file directory and name.")
    return arg.parse_args()

if __name__ == "__main__":
    arguments = args()
    infile = open(arguments.file, 'rb') #import file
    out = open(arguments.out_file, 'w') #export file
